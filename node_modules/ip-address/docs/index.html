...
addressAndPort.port; <span class="hljs-comment">// 8080</span></pre>
  ...
  <p>Create an IPv6-mapped address given an IPv4 address</p>
    ...
    <div class='py1 quiet mt1 prose-big'>Example</div>
      ...
      <pre class='p1 overflow-auto round fill-light'><span class="hljs-keyword">var</span> address = Address6.fromAddress4(<span class="hljs-string">'192.168.0.1'</span>);
address.correctForm(); <span class="hljs-comment">// '::ffff:c0a8:1'</span>
address.to4in6(); <span class="hljs-comment">// '::ffff:192.168.0.1'</span></pre>
...
address.to4(); <span class="hljs-comment">// '24.37.191.17'</span></pre>
